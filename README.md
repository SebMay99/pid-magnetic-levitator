...
├── docs/
│   ├── Magnetic_Levitation.pptx     # Project presentation
│   ├── ResultsGraphs.pdf            # Hall sensor response graphs
│   └── ResultsGraphs.docx           # Results document
└── README.md
```
...
![PCB Schematic](docs/graphs/pcb_schematic.png)
...
![Set Point 630](docs/graphs/graph_setpoint_630.png)

### Graph 2 — Set Point: 700
![Set Point 700](docs/graphs/graph_setpoint_700.png)

### Graph 3 — Set Point: 730
![Set Point 730](docs/graphs/graph_setpoint_730.png)
